...
#define HPX_TUPLE_MAX HPX_PP_ROUND_UP_ADD3(HPX_TUPLE_LIMIT)
...
namespace boost { namespace fusion
{
            ...
            , random_access_traversal_tag>
    {
        ...
        struct value_of
          : hpx::util::tuple_element<Iterator::index,
    ...
    namespace extension
    {
        ...
        struct at_impl<hpx::util::detail::tuple_tag>
        {
            ...
            struct apply
            {
                ...
                typedef typename hpx::util::tuple_element<I::value, seq_type>::type element;
...
namespace boost { namespace fusion
{
    namespace extension
    {
        ...
        struct end_impl<hpx::util::detail::tuple_tag>
        {
            ...
            {
                typedef typename remove_const<Sequence>::type seq_type;
                static int const size = hpx::util::tuple_size<seq_type>::value;
...
namespace boost { namespace fusion
{
    namespace extension
    {
        ...
        {
            template <typename Sequence, typename I>
            struct apply : hpx::util::tuple_element<I::value, Sequence> {};
        };
    }
}}
